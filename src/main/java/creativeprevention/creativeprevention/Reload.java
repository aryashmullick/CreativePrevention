        ...
        if(cmd.getName().equalsIgnoreCase("cp")){
            try {
                ...
                if (argOne.equalsIgnoreCase("reload")){
                    ...
                    sender.sendMessage(ChatColor.GOLD + "[CreativePrevention] " + ChatColor.DARK_GRAY + "Version: " + ChatColor.BLUE+ CreativePrevention.version);
                    sender.sendMessage(ChatColor.GOLD + "[CreativePrevention] " + ChatColor.AQUA + "/cp help" + ChatColor.GREEN+ " -> This command");
                    sender.sendMessage(ChatColor.GOLD + "[CreativePrevention] " + ChatColor.AQUA + "/cp reload" + ChatColor.GREEN+ " -> Reloads configuration file");
                    return true;
                } else{
